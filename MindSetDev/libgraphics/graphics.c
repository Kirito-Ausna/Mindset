 ...
 */
 /*
 content:
 part1:全局变量（Global variables）172行 
 Section 1 -- Basic functions from graphics.h 314行 
 Section 2 -- Elliptical arcs 388行
 Section 3 -- Graphical structures 414行
 Section 4 -- String functions 440行 
 Section 5 -- Mouse support 517行
 Section 6 -- Color support 562行 
